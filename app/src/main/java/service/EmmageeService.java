...
import com.waimai.baidu.wmperformancetool.MainActivity;
import com.waimai.baidu.wmperformancetool.MainPageActivity;
import com.waimai.baidu.wmperformancetool.R;

import utils.Constants;
import utils.CpuInfo;
import utils.CurrentInfo;
import utils.EncryptData;
import utils.FpsInfo;
import utils.MemoryInfo;
...
public class EmmageeService extends Service {
	...
	public void onCreate() {
		Log.i("Emmagee-onCreate", "service onCreate");
		super.onCreate();
		isServiceStop = false;
		isStop = false;
		fpsInfo = new FpsInfo();
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		Log.i("jhjhjhjhjh", "service onStart");
